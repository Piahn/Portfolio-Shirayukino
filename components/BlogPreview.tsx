          ...
          <div className="mx-auto max-w-[1220px]">
            <div className="flex items-end justify-between gap-4">
              ...
              <button
                ...
                className="hidden sm:inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#142d55] dark:text-[#E5BA68] transition hover:text-black dark:hover:text-white font-mono cursor-pointer"
              >
            ...
            <div className="mt-10 grid gap-4 lg:grid-cols-3">
              {posts.map((post) => (
                <article
                  ...
                  className="cursor-pointer group flex min-h-[300px] flex-col justify-between rounded-[21px] border border-[#e7e3df] dark:border-[#1a2840] bg-[#f8f5f2] dark:bg-[#0c1524] p-7 transition-all duration-300 hover:border-[#142d55]/50 dark:hover:border-[#E5BA68]/50 hover:shadow-md dark:shadow-[0_4px_24px_rgba(0,0,0,0.3)]"
                >
                  <div>
                  ...
                  <div className="mt-8 border-t border-[#ddd7d0] dark:border-[#1a2840] pt-4 transition-colors flex items-center justify-between">
                    <span className="inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#142d55] dark:text-[#E5BA68] transition group-hover:translate-x-0.5 font-mono">
                      Read article
                      <HiArrowUpRight size={13} />
                    </span>
                  </div>
